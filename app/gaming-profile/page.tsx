        ...
        try {
            ...
            setProfileData(prev => {
                ...
                return {
                    ...
                    avatar: editedProfile.avatar ? URL.createObjectURL(editedProfile.avatar) : prev.avatar,
                    ...
                    <div className="profile-info">
                        ...
                        <div className="profile-stats">
                            <div className="stat-item">
                                ...
                                <span className="stat-value">{profileData?.totalPlayTime} hours</span>
                            </div>
                            <div className="stat-item">
                                <span className="stat-label">Games Played</span>
                                <span className="stat-value">{profileData?.playedGames.length}</span>
                            </div>
                            <div className="stat-item">
